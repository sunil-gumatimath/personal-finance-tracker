...
-- ====================================================================
-- 
-- This is adapted from the Supabase schema for Neon
-- Note: We'll use a separate auth.users table or keep Supabase auth
--
-- HOW TO USE:
--   1. Copy this entire file into Neon SQL Editor
--   2. Click "Run" to create tables and functions
--   3. If keeping Supabase auth, user_id will reference Supabase auth.users
--   4. If using separate auth, create auth.users table first
--
-- ====================================================================
...
-- TABLE: profiles
-- =====================================================
-- Note: user_id references auth.users (from Supabase) or your auth system
CREATE TABLE profiles (
  id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
  user_id UUID NOT NULL UNIQUE, -- Will reference Supabase auth.users or your auth system
  full_name TEXT,
  avatar_url TEXT,
...
CREATE TABLE accounts (
  id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
  user_id UUID NOT NULL, -- Will reference Supabase auth.users or your auth system
  name TEXT NOT NULL,
...
-- =====================================================
-- Note: This function requires user_id to be set via session variable
-- For Neon, we'll pass user_id as a parameter instead
...
-- ====================================================================
-- SETUP COMPLETE!
-- After signing up, run: SELECT seed_my_data('your-user-id-here');
-- ====================================================================
